...
def TextDataToCTF(inputfile,outputfile,outputfile2,isEvaluation,check):
    ...
    if outputfile2 != "":
        fw2 = open(outputfile2,"w",encoding="utf-8")
    for line in f:
        ...
        if check == 1:
            if label == "0":
                label_str = " 1 0 "
                fw2.write("|qfeatures "+query_feature_vector+" |pfeatures "+passage_feature_vector+" |labels "+label_str+"\n")
            else:
                label_str = " 0 1 "
...
if __name__ == "__main__":
    ...
    trainFileName = "trainingdata.tsv"
    ...
    # TextDataToCTF(trainFileName,"Train_positive.ctf","Train_negative.ctf",False,1)
    # print("Train Data conversion is done")
    TextDataToCTF(validationFileName,"ValidationData.ctf","",False,0)
    print("Validation Data conversion is done")
    # TextDataToCTF(EvaluationFileName,"EvaluationData.ctf","",True,0)
