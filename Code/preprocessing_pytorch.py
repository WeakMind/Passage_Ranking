# -*- coding: utf-8 -*-
"""
Created on Mon Nov 26 10:36:18 2018
...
if __name__ == "__main__":
    ...
    TextDataToCTF(trainFileName,"TrainData.txt",False)
    print("Train Data conversion is done")
    TextDataToCTF(validationFileName,"ValidationData.txt",False)
    print("Validation Data conversion is done")
    TextDataToCTF(EvaluationFileName,"EvaluationData.txt",True)
